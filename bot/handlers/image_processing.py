...
STYLE_DESCRIPTIONS = {
    ...
    "realism": "Максимально точное изображение, приближенное к фотографии.",
    ...
    "pixelart": "Изображение в стиле ретро-игр с крупными пикселями.",
    "fantasy": "Магические пейзажи, сказочные персонажи и необычные цвета.",
    "cyberpunk": "Неоновые огни, высокотехнологичные города и урбанистический антураж.",
    "steampunk": "Викторианская эстетика с элементами механизмов и паровых машин.",
    "gothic": "Мрачная, атмосферная и таинственная стилистика.",
    "synthwave": "Яркие неоновые цвета и ретро-футуризм 80-х.",
    "comic": "Яркие контуры, выразительные линии и комиксная подача.",
    "cartoon": "Утрированные формы, яркие цвета и мультяшная стилизация.",
    "isometric": "Трёхмерное изображение в изометрической проекции.",
