...
STYLE_DESCRIPTIONS = {
    ...
    "cyberpunk": "Неоновый стиль будущего с яркими огнями, городскими пейзажами и высоким контрастом.",
    "makeup": "Добавление макияжа: акцент на глаза, губы и естественное сияние кожи.",
    "business": "Формальный деловой стиль: костюм, галстук или офисная одежда, без изменения позы и лица.",
}
